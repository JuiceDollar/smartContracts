...
export default buildModule('StablecoinBridgeUSDC', (m) => {
  ...
  const stablecoinBridgeUSDC = m.contract('StablecoinBridge', [other, juiceDollar, limit, weeks], {
    id: 'StablecoinBridgeUSDC',
  });

  return { stablecoinBridgeUSDC };
});
