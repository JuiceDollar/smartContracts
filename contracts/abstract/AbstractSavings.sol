...
import {AbstractLeadrate} from "./AbstractLeadrate.sol";

/**
 * @title AbstractSavings
 *
 ...
 *
 * Users can deposit JuiceDollar (JUSD) into the module and earn interest on the
 * deposited amount. The deposited JUSD stays in the module and is kept on separate
 * accounts within the module, preserving legal segregation.
 */
abstract contract AbstractSavings is AbstractLeadrate {
    ...
    // The module is considered disabled if the interest is zero or about to become zero.
    error ModuleDisabled();

    constructor(IERC20 jusd_) {
        jusd = jusd_;
    }
     ...
     */
    function save(address owner, uint192 amount) public virtual {
